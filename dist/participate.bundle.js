...
var _dynamicLayout = __webpack_require__(190);

var _dynamicLayout2 = _interopRequireDefault(_dynamicLayout);

var _templateElements = __webpack_require__(191);
...
jQuery(document).ready(function ($) {
  ...
  const setHeaderBG = () => {
    $('.top-banner').css({
      backgroundImage: `url('${_utils.url}/wp-content/uploads/2018/05/participate-header.jpg')`
    });
  };
...
const descriptionTxtBlock = exports.descriptionTxtBlock = course => `
