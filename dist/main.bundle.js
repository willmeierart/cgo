...
jQuery(document).ready($ => {
  ...
  const prependAudioBtn = () => {
    $('.prepend-audio').css({
      ...
      <a class='audio-btn'><img src='${_utils.url}/wp-content/uploads/2018/05/icon-audio.png' /></a>
    `);
    $('.audio-btn').css({
      maxWidth: '30px'
    }).hover(btn => {
...
var _facebookIcon = __webpack_require__(145);

var _facebookIcon2 = _interopRequireDefault(_facebookIcon);

var _instagramIcon = __webpack_require__(146);

var _instagramIcon2 = _interopRequireDefault(_instagramIcon);

var _twitterIcon = __webpack_require__(147);
...
jQuery(document).ready(function ($) {
  ...
  const shuffleList = () => {
    ...
    items.each((i, item) => {
      ...
      if (txtContent === 'Spiritual Lineage') $(item).addClass('mobile-exp').children('a').attr('href', '/explore/spiritual-lineage');
      ...
      // }
      if (txtContent === 'Participate') $(item).addClass('mobile-exp').children('a').attr('href', '/participate/meditation');
      // .attr('href', window.innerWidth >= 1000 ? '/participate/meditation' : '')
      if (txtContent === 'Explore') $(item).addClass('mobile-exp').children('a').attr('href', '/explore/purpose');
...
var _cgoHeaderLogo = __webpack_require__(149);
...
jQuery(document).ready(function ($) {
  ...
  const handleMobileMenu = (newIdx, oldIdx, txt) => {
    ...
    views.forEach(async (view, i) => {
      ...
      if (view === thisView) {
        ...
        setTimeout(() => {
          console.log('transform2', view.css('transform'));
        }, 501);
  ...
  const initMobileMenu = () => {
    ...
    $('#top').find('.col-1').css({ textAlign: 'right!important' }).children('ul').css({ alignItems: 'flex-end' });
    ...
    $('#side-nav li').each((i, li) => {
      ...
      if ($(a).text() === 'Explore' || $(a).text() === 'Participate') {
        ...
        $(li).click(e => {
          ...
          e.preventDefault();
          if ($(li).hasClass('has-children')) {
            (0, _lodash2.default)(() => setMobileView(mobileMenuView + 1, $(li).text()), 200, { trailing: false, leading: true })();
          }
        });
      }
    });
    ...
    $('.col-2').find('.submenu-item').each((i, subLi) => {
      if ($(subLi).hasClass('has-children')) {
        ...
        $(subLi).click(e => {
          // e.preventDefault()
          (0, _lodash2.default)(() => setMobileView(mobileMenuView + 1), 200, { trailing: false, leading: true })();
        });
      }
    });
