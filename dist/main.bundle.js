...
jQuery(document).ready(function ($) {
  ...
  const shuffleList = () => {
    ...
    items.each((i, item) => {
      ...
      if (txtContent === 'Spiritual Lineage') $(item).addClass('mobile-exp').children('a').attr('href', window.innerWidth >= 1000 ? '/explore/spiritual-lineage' : '');
      ...
      // }
      if (txtContent === 'Participate') $(item).addClass('mobile-exp').children('a').attr('href', window.innerWidth >= 1000 ? '/participate/meditation' : '');
      if (txtContent === 'Explore') $(item).addClass('mobile-exp').children('a').attr('href', window.innerWidth >= 1000 ? '/explore/purpose' : '');
    });
